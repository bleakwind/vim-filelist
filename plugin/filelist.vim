...
" fold and file color
let g:filelist_hglg                 = get(g:, 'filelist_hglg',                {})
let g:filelist_hglg.setmark         = get(g:filelist_hglg, 'setmark',         '#A1ACA3')
let g:filelist_hglg.seticon         = get(g:filelist_hglg, 'seticon',         '#A1ACA3')
let g:filelist_hglg.foldclose       = get(g:filelist_hglg, 'foldclose',       '#92BDE8')
let g:filelist_hglg.foldopen        = get(g:filelist_hglg, 'foldopen',        '#92BDE8')
let g:filelist_hglg.filedefault     = get(g:filelist_hglg, 'filedefault',     '#DDDDDD')
let g:filelist_hglg.fileexecute     = get(g:filelist_hglg, 'fileexecute',     '#EEBE77')
let g:filelist_hglg.filesymlink     = get(g:filelist_hglg, 'filesymlink',     '#95D475')
let g:filelist_hglg.bmlisttitle     = get(g:filelist_hglg, 'bmlisttitle',     '#92BDE8')
let g:filelist_hglg.helplisttitle   = get(g:filelist_hglg, 'helplisttitle',   '#92BDE8')
...
" copyright manage
let g:filelist_cprt                 = get(g:, 'filelist_cprt',                {})
let g:filelist_cprt.nickname        = get(g:filelist_cprt, 'nickname',        'NickName')
let g:filelist_cprt.fullname        = get(g:filelist_cprt, 'fullname',        'FullName')
let g:filelist_cprt.mailaddr        = get(g:filelist_cprt, 'mailaddr',        'author@example.com')
let g:filelist_cprt.progtype        = get(g:filelist_cprt, 'progtype',        ['<?php', '<%asp'])
let g:filelist_cprt.cpywidth        = get(g:filelist_cprt, 'cpywidth',        78)
let g:filelist_cprt.tplcrcon        = get(g:filelist_cprt, 'tplcrcon',        [
            \ '/* vim: set expandtab tabstop=4 softtabstop=4 shiftwidth=4: */',
            \ '/**',
            \ ' * +-------------------------------------------------------------------------+',
...
if exists('g:filelist_enabled') && g:filelist_enabled ==# 1
    ...
    function! filelist#WinDatalist(...) abort
        if s:filelist_winidn != -1 && win_id2win(s:filelist_winidn) != 0
            ...
            if exists('s:filelist_helpstate') && s:filelist_helpstate
                call filelist#HelpRender(l:lines)
            endif
    ...
    function! filelist#GetNode(...) abort
        ...
        endwhile
        return l:found_fldata ? l:fldata : {}
    endfunction
    ...
    function! filelist#MouseNode(...) abort
        ...
        if l:oper ==# 1 && (l:curr_time - s:filelist_msetimer) < 0.3
            ...
            if l:click_wid ==# l:orig_winidn
                call setpos('.', [0, l:click_lin, l:click_col, 0])
            ...
            if empty(l:curr_file)
                ...
                if !empty(l:path_list)
                    ...
                    if l:fldata.path ==# l:curr_file
                        ...
                        call setpos('.', [0, line('.'), l:name_start, 0])
                    endif
                endif
            endif
        endif
    ...
    function! filelist#WinOpen(...) abort
        if s:filelist_winidn ==# -1 || win_id2win(s:filelist_winidn) ==# 0
            ...
            nnoremap <silent> <buffer> ?             :<C-U>call filelist#HelpToggle()<CR>
    ...
    " filelist#HelpRender
    " --------------------------------------------------
    function! filelist#HelpRender(lines) abort
        " init highlight
        if !exists('w:filelist_highlight')
            let w:filelist_highlight = []
        endif
    ...
    " filelist#HelpToggle
    " --------------------------------------------------
    function! filelist#HelpToggle() abort
        if exists('s:filelist_helpstate') && s:filelist_helpstate
            call filelist#HelpClose()
        else
            call filelist#HelpOpen()
        endif
    endfunction
    ...
    function! filelist#SetHlcolor(...) abort
        ...
        let l:hlsetmark       = filelist#ColorBgtype(l:gbg) ==# "White" ? filelist#ColorInvert(g:filelist_hglg.setmark)       : g:filelist_hglg.setmark
        let l:hlseticon       = filelist#ColorBgtype(l:gbg) ==# "White" ? filelist#ColorInvert(g:filelist_hglg.seticon)       : g:filelist_hglg.seticon
        let l:hlfoldclose     = filelist#ColorBgtype(l:gbg) ==# "White" ? filelist#ColorInvert(g:filelist_hglg.foldclose)     : g:filelist_hglg.foldclose
        let l:hlfoldopen      = filelist#ColorBgtype(l:gbg) ==# "White" ? filelist#ColorInvert(g:filelist_hglg.foldopen)      : g:filelist_hglg.foldopen
        let l:hlfiledefault   = filelist#ColorBgtype(l:gbg) ==# "White" ? filelist#ColorInvert(g:filelist_hglg.filedefault)   : g:filelist_hglg.filedefault
        let l:hlfileexecute   = filelist#ColorBgtype(l:gbg) ==# "White" ? filelist#ColorInvert(g:filelist_hglg.fileexecute)   : g:filelist_hglg.fileexecute
        let l:hlfilesymlink   = filelist#ColorBgtype(l:gbg) ==# "White" ? filelist#ColorInvert(g:filelist_hglg.filesymlink)   : g:filelist_hglg.filesymlink
        let l:hlbmlisttitle   = filelist#ColorBgtype(l:gbg) ==# "White" ? filelist#ColorInvert(g:filelist_hglg.bmlisttitle)   : g:filelist_hglg.bmlisttitle
        let l:hlhelplisttitle = filelist#ColorBgtype(l:gbg) ==# "White" ? filelist#ColorInvert(g:filelist_hglg.helplisttitle) : g:filelist_hglg.helplisttitle
        let l:hlhelplistkey   = filelist#ColorBgtype(l:gbg) ==# "White" ? filelist#ColorInvert(g:filelist_hglg.helplistkey)   : g:filelist_hglg.helplistkey
        let l:hlhelplistdes   = filelist#ColorBgtype(l:gbg) ==# "White" ? filelist#ColorInvert(g:filelist_hglg.helplistdes)   : g:filelist_hglg.helplistdes
        ...
        execute 'hi! FilelistHlHelplistTitle ctermfg='.filelist#ColorName(l:hlhelplisttitle).' ctermbg=NONE cterm=NONE guifg='.l:hlhelplisttitle.' guibg=NONE gui=NONE'
        execute 'hi! FilelistHlHelplistKey   ctermfg='.filelist#ColorName(l:hlhelplistkey)  .' ctermbg=NONE cterm=NONE guifg='.l:hlhelplistkey  .' guibg=NONE gui=NONE'
